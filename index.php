...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    <font class="edoc-logo">eAppointment </font>
                    <font class="edoc-logo-sub">| Kwahu Government Hospital</font>
                </td>
                <td width="10%">
            ...
            <tr>
                <td  colspan="3">
                    <p class="sub-text2">Kwahu Government Hospital makes it easier to meet your preferred doctor.<br>Don't worry. Find your doctor online Book as you wish with eAppointment. <br>
        ...
        <p class="sub-text2 footer-hashen"> SIMTech &copy; <?php echo date("Y"); ?> </p>
    </center>
